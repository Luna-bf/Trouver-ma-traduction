...
<main class="settings-container">
    <section class="settings-parent d-flex">
        ...
        <ul class="all-settings d-flex">
            <li class="border-left"><a href="/settings/profile-settings" class="d-flex"><i
                        class="fa-solid fa-user"></i>Profil</a></li>
            <li><a href="/settings/preferences" class="d-flex"><i class="fa-solid fa-paperclip"></i>Préférences de
                    contenu</a></li>
        ...
        <div class="profile-params separator">
            <div class="profile-picture d-flex">
                ...
                <ul>
                    <li>John Doe</li>
                    <li><a href="/settings/upload-profile-picture">Changer votre photo de profil</a></li>
                </ul>
            </div>
