...
<head>
    ...
    <title>Inscription - Trouver Ma Traduction</title>
...
<body class="forms-body">
    <main class="form-container d-flex">
        <div class="form-parent d-flex">
            ...
            <form action="form.php" method="post" class="d-flex">

                <div class="w-50-percent d-i-flex form-input-parent">
                    <label for="username" class="w-50-percent mb-10 mt-first-label sign-label">Nom d'utilisateur</label>
                    <input type="text" class="form-input" id="username">
                </div>

                <div class="w-50-percent d-i-flex form-input-parent">
                    <label for="email" class="w-50-percent mb-10 mt-second-label sign-label">Email</label>
